...
resource "账目" do
  ...
  get "/api/v1/items" do
    ...
    example "获取账目" do
      ...
      11.times do 
        Item.create! amount: 100, happend_at: '2020-10-30', tags_id: [tag.id], 
  ...
  get "/api/v1/items/summary" do
    ...
    example "统计信息（按happend_at分组）" do
      ...
      do_request group_by: 'happend_at'
      expect(status).to eq 200
      json = JSON.parse response_body
